...
// 用户头像 - 更新为更好看的图像
const userAvatar = '/assets/images/user.jpeg';

// 管家头像 - 更新为更专业的管家图标
const butlerAvatar = '/assets/images/system-avatar.jpg';
  ...
  window.appData = {
    ...
    initializeMessages() {
      ...
      this.systemMessages = [
        ...
        },
        {
          ...
          type: 'system',
          contentType: 'text',
          content: '根据最新监测数据，您的所有宠物今天状态良好：一点点活动量增加20%，阿努比斯的睡眠质量优，咪咕进食正常，刘看山的体重略有增加但在健康范围内。',
        ...
        // 周报信息文本形式
        {
          ...
          type: 'system',
          contentType: 'text',
          content: '【本周宠物健康周报】您所有的宠物本周健康状况优良，一点点运动量较上周增加15%。详细数据请查看周报卡片。',
    ...
    simulateSystemReply(userMessage) {
      ...
      if (userMessage.includes('报告') || userMessage.includes('数据')) {
        ...
        reply = `根据最新监测数据，您的所有宠物今天状态良好：一点点活动量增加20%，阿努比斯的睡眠质量优，咪咕进食正常，刘看山的体重略有增加但在健康范围内。`;
      } else if (userMessage.includes('预警') || userMessage.includes('异常')) {
        reply = '最近24小时内，检测到一点点有轻微的啃咬笼子行为，建议提供木质玩具；阿努比斯的饮水量略低于平均水平，请确保提供新鲜水源。其他宠物未发现异常。';
        ...
        reply = `您好，我是智能管家。我会为您提供所有宠物的健康报告、实时状态和环境数据。目前一点点、阿努比斯、咪咕和刘看山的健康状况总体良好，有任何需要了解的特定信息，请随时告诉我。`;
      }
