...
export const messageData = [
  // 前天的消息
  {
    ...
    type: 'system',
    contentType: 'text',
    content: '周一健康提醒：一点点的饮水量略低于平均水平，建议多关注饮水情况。',
  ...
  },
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '一点点，你今天要记得喝足够的水？我看系统提醒你最近饮水量不足。',
  ...
  // 昨天的消息
  {
    ...
    type: 'system',
    contentType: 'text',
    content: '一点点的日报已生成，昨天总活动时间4.2小时，较平时增加15%，健康状况良好。',
  ...
  },
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '一点点，你今天有玩你的新迷宫吗？我特意给你挑选的，希望你会喜欢！',
  ...
  // 今天的消息
  {
    ...
    type: 'system',
    contentType: 'text',
    content: '早上好！今天是周二，气温22-28°C，阳光明媚，适合让一点点在阳光下活动一下哦！',
  ...
  },
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '一点点早上好，今天有好好吃饭吗？你最喜欢的葵花籽我又买了一大包！',
  ...
  },
  {
    ...
    type: 'system',
    contentType: 'text',
    content: '检测到一点点在咬笼子栏杆，可能是牙齿需要磨一磨，建议提供适合啃咬的木制玩具。',
  ...
  // 添加更多聊天消息
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '一点点，我最近发现你特别喜欢跑轮呢！你每天在上面跑多久呀？',
  ...
  },
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '一点点你最近有什么特别想吃的食物吗？我可以明天去超市多买一些！',
  ...
  },
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '一点点，你今天有没有好好运动啊？我听说运动对小仓鼠很重要，能帮助你保持健康！',
  ...
  // 当前时间
  {
    ...
    type: 'user',
    contentType: 'voice',
    content: '晚上好啊一点点，我马上就到家了！你想我了吗？我给你带了新鲜的水果！',
...
export const reportData = {
  daily: {
    ...
    summary: '今天一点点的活动状态良好，精神充沛，饮食正常。',
    activityData: {
  ...
  weekly: {
    ...
    type: 'weekly',
    date: '2023年5月第3周',
    summary: '本周一点点的整体状态良好，活动量适中，饮食规律，睡眠充足。',
    activityData: {
  ...
  monthly: {
    ...
    type: 'monthly',
    date: '2023年5月',
    summary: '本月一点点的健康状况稳定，体重增加了5克，饮食习惯良好，活动规律。',
    activityData: {
...
export const groupMessages = [
  ...
  },
  {
    ...
    petId: 'pet-001',
    contentType: 'voice',
    content: '大家好啊！我是仓鼠一点点，今天跑轮跑得超快的！(^o^)',
  ...
  },
  {
    ...
    category: 'chat',
    urgent: 0,
    mediaUrl: '/assets/images/paolun.png',
  },
  {
    id: 'group-msg-008',
    type: 'pet',
  ...
  },
  {
    ...
    petId: 'pet-002',
    contentType: 'voice',
    content: '哼哼～作为月亮猫咪，捕捉飞行生物是我与生俱来的使命！一点点你要学习的话，我可以教你喵～',
...
export const systemMessagesV2 = [
  {
    ...
    chartData: {
      ...
      feedingData: {
        meals: [
          {time: "08:30", petNames: ["一点点", "阿努比斯", "阿努比斯", "刘看山"], amount: "正常"},
          {time: "12:45", petNames: ["一点点", "阿努比斯", "刘看山"], amount: "正常"},
          {time: "13:20", petNames: ["阿努比斯"], amount: "少量"},
          {time: "18:00", petNames: ["一点点", "阿努比斯", "阿努比斯", "刘看山"], amount: "正常"}
        ],
        waterIntake: {
          petNames: ["一点点", "阿努比斯", "阿努比斯", "刘看山"],
          values: [85, 65, 90, 95],
      ...
      momentHighlights: [
        {petName: "一点点", time: "10:23", description: "在跑轮上跑了20分钟", imageUrl: "https://images.pexels.com/photos/4520474/pexels-photo-4520474.jpeg?auto=compress&cs=tinysrgb&w=600"},
  ...
  },
  {
    ...
    contentType: "report-card",
    title: "本周宠物健康周报",
    summary: "您所有的宠物本周健康状况优良，一点点运动量较上周增加15%。",
    details: "查看完整周健康报告",
    ...
    chartData: {
      weeklyTrend: {
        ...
        datasets: [
          {name: "一点点", values: [60, 70, 65, 75, 68, 80, 85]},
    ...
    chartData: {
      monthlyHealth: {
        ...
        categoryScores: {
          ...
          datasets: [
            {name: "一点点", values: [90, 95, 85, 92, 94]},
      ...
      behaviorChanges: {
        ...
        datasets: [
          {name: "一点点-活动", values: [60, 65, 70, 75]},
      ...
      anomalies: [
        {petName: "一点点", week: "第2周", issue: "轻微食欲下降", resolution: "已调整饮食，恢复正常"},
      ...
      growthTracking: {
        months: ["8月", "9月", "10月"],
        weights: [
          {name: "一点点", values: [0.13, 0.14, 0.145]},
